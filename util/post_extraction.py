    ...
    def extract_post(self, post_id):
        ...
        try:
            username_element = self.driver.find_element(
                By.XPATH,
                "//div[@class='x9f619 xjbqb8w x78zum5 x168nmei x13lgxp2 x5pf9jr xo71vjh x1uhb9sk x1plvlek xryxfnj x1c4vz4f x2lah0s x1q0g3np xqjyukv x1qjc9v5 x1oa3qoh x1nhvcw1']/span/div/a/div/div/span",
            )
        ...
        try:
            post_content_element = self.driver.find_element(
                By.XPATH,
                "//div/span[@class='x193iq5w xeuugli x1fj9vlw x13faqbe x1vvkbs xt0psk2 x1i0vuye xvs91rp xo1l8bm x5n08af x10wh9bi x1wdrske x8viiok x18hxmgj']",
            )
        ...
        # Extract post date
        try:
            datetime_post_element = self.driver.find_element(
                By.XPATH,
                "//span[@class='x193iq5w xeuugli x1fj9vlw x13faqbe x1vvkbs xt0psk2 x1i0vuye xvs91rp xo1l8bm x1roi4f4 x10wh9bi x1wdrske x8viiok x18hxmgj']/time[@class='xsgj6o6']",
            )
